                            ...
                            <table class="table">
                                <tbody class="m-control">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control input-sm sel">
                                                ...
                                                <option ${userInfo.userEmail2 eq '@gamil.com' ? 'selected' : ''}>gmail.com</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control input-sm add" value="addrBasic"></td>
                                    </tr>
                                    <tr>
                                        <td class="m-title">*상세주소</td>
                                        <td><input class="form-control input-sm add" value="addrDetail"></td>
                                    </tr>
                                </tbody>
                            </table>
                            </form>
