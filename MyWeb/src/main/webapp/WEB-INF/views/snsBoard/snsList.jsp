			...
			<div class="col-xs-12 col-sm-8 section-inner">
				...
				<div id="contentDiv">
					...
					<div class="link-inner">
						...
						<a href="##"><i class="glyphicon glyphicon-comment"></i>댓글달기</a> <a
							href="##"><i class="glyphicon glyphicon-remove"></i>삭제하기</a>
					</div> -->
				</div>
			</div>
			<!--우측 어사이드-->
		...
		function getList(){
			$.getJSON("getList", function(list){
					...
					for(var i = 0 ; i < list.length; i++){
						...
						str += '<href="##"><i class="glyphicon glyphicon-remove"></i>삭제하기</a>';	
						str += '</div>';
						} //end for
						$("#contentDiv").html(str);
